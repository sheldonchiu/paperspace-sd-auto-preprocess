...
wd14_general_thresh = float(os.environ.get('WD14_GENERAL_THRESHOLD', 0.35))
wd14_character_thresh = float(os.environ.get('WD14_CHARACTER_THRESHOLD', 0.35))
...
filter_by_resolution = bool_t(os.environ.get('FILTER_BY_RESOLUTION', '0'))
filter_min_resolution = int(os.environ.get('FILTER_MIN_RESOLUTION', 1024))
...
bucketing_enable_upscale = bool_t(os.environ.get('BUCKETING_ENABLE_UPSCALE', '0'))
